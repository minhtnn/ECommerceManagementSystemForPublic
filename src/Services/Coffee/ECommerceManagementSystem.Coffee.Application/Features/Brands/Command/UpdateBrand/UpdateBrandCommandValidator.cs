...
public class UpdateBrandCommandValidator : AbstractValidator<UpdateBrandCommand>
{
    ...
    public UpdateBrandCommandValidator()
    {
        ...
        RuleFor(x => x.Fullname)
            .MaximumLength(200).WithMessage("Tên đầy đủ của thương hiệu không vượt quá 200 ký tự");

        RuleFor(x => x.Slogan)
            .MaximumLength(500).WithMessage("Khẩu hiệu của thương hiệu không vượt quá 500 ký tự");
        ...
        // ← thêm: validate Configuration nếu có truyền vào
